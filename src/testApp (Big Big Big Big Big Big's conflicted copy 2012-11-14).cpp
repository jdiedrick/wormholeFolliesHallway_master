...
void testApp::setup(){
    ...
    chromaMovie.loadMovie("../../../movies/chromad.mov");
...
void testApp::update(){
    ...
    if(movie.isFrameNew()){
        ...
        vidPixels = movie.getPixelsRef();
            ...
            //chromaMovie.getTextureReference();
...
void testApp::draw(){
    ...
    if(drawRuttEtra){
            ...
            if (rowCount % 2 == 0) {
                for (int x = 0; x < movie.width; x += xStep){
                    ...
                    if(y<movie.getWidth()/2){
                        mesh.addVertex(ofVec3f(x, y+curColor.getBrightness() * 0.3 + fftSmoothed[y]*50.f, -1));
                    } else {
                        mesh.addVertex(ofVec3f(x, y - curColor.getBrightness() * 0.3 - fftSmoothed[y]*50.f, -1));
                    }
        ...
        chromaMovie.draw(mouseX,mouseY, 100, 300);
        ...
        //chromaMovie.draw(20,20, 100, 300);
